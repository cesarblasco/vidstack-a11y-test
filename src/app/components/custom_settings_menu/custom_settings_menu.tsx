import { Menu, MediaKeyShortcuts } from "@vidstack/react";
import {
  ArrowLeftIcon,
  ChevronRightIcon,
  ComputerIcon,
...
import {
  ...
  defaultMediaPlayerKeyShortcuts,
} from "@/app/helpers/video_player_shortcuts";

import styles from "./custom_settings_menu.module.css";

interface CustomSettingsMenuProps {
  currentMediaKeyShortcuts: MediaKeyShortcuts;
  onSetMediaPlayerKeyShortcuts: (mediaKeyShortcuts: MediaKeyShortcuts) => void;
}
...
const CustomSettingsMenu = ({
  ...
  const handleSetMediaPlayerKeyShortcuts = () => {
    ...
    const newMediaKeyShortcuts =
      currentMediaKeyShortcuts.type === "default"
        ? disabledMediaPlayerKeyShortcuts
        : defaultMediaPlayerKeyShortcuts;
